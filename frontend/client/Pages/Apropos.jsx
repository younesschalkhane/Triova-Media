    ...
    <>
        ...
        <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h2 className="mt-5 text-4xl md:text-5xl font-bold leading-tight tracking-tight">
              ...
              <span className="text-violet-600">de Triova-Media</span>
            </h2>
          ...
          <div className="relative">
            <img
              ...
              className="w-full h-[400px] md:h-[520px] object-cover rounded-3xl shadow-2xl"
            />
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-sky-100 via-violet-50 to-violet-100 py-24 px-6">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          {/* 3 Cards - Same hover effect as homepage cards */}
          <div className="mt-20 grid md:grid-cols-3 gap-8 text-left">
            <div className="group relative bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
              ...
              <Sparkles className="w-8 h-8 text-sky-500 mb-4" />
              <h3 className="text-xl font-semibold text-violet-600 mb-3">Stratégie</h3>
            ...
            <div className="group relative bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
              <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-sky-500 to-violet-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <Diamond className="w-8 h-8 text-violet-500 mb-4" />
              <h3 className="text-xl font-semibold text-violet-600 mb-3">Création</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="group relative bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
              <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-sky-500 to-violet-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <Triangle className="w-8 h-8 text-emerald-500 mb-4" />
              <h3 className="text-xl font-semibold text-violet-600 mb-3">Performance</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
      ...
      <section className="relative py-24 px-6 overflow-hidden bg-white">
        ...
        <div className="relative max-w-6xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold">
            <span className="text-sky-500">Notre</span>{" "}
            <span className="text-violet-600">Équipe</span>
          </h2>
