      ...
      <section className=" py-12 bg-gradient-to-br from-violet-50 via-violet-100 to-sky-100">
        ...
        <div className="  gap-15   text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg text-slate-600 ">
            Chez{" "}
            <span className="font-semibold text-slate-800">Triova Media</span>,
            nous accompagnons les entreprises dans leur croissance digitale grâce
            à des solutions modernes en création web, branding, SEO, intelligence
            artificielle et campagnes publicitaires.
          </p>
        </div>
      </section>
      ...
      {successMessage && (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 max-w-md w-full text-center">
            ...
            <p className="text-xs text-gray-400 mt-3">Fermeture...</p>
          </div>
        </div>
      )}
          ...
          <div className="bg-white rounded-3xl shadow-xl p-10 scale-105 h-200 flex flex-col justify-center   ">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-3 rounded-full hover:opacity-90 transition disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {submitting ? (
                  <>
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-gray-600 mb-6">
              ...
              <span className="font-bold">
                {" "}
                notre équipe de Triova Marketing{" "}
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-4 rounded-xl shadow flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">+212 56642217</p>
                </div>
              </div>
            ...
            <div className="mt-6 flex items-center justify-around">
              {/* LEFT TEXT */}
              <p className="font-bold text-gray-900">Suivez-nous :</p>
